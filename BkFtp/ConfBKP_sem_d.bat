...
mkdir BACKUP\BK_%1\Ampa
mkdir BACKUP\BK_%1\Amav
mkdir BACKUP\BK_%1\Educam
...
move bdampa.sql.tar.gz BACKUP\BK_%1\Ampa\bdampa.sql.tar.gz
move bdamav.sql.tar.gz BACKUP\BK_%1\Amav\bdamav.sql.tar.gz
move bdeducam.sql.tar.gz BACKUP\BK_%1\Educam\bdeducam.sql.tar.gz
