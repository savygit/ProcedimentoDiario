...
<html>
    ...
    <style>
        ...
        div.msdos{border-radius: 5px; background-color:#000000; color:#ffffff; font-weight: bold; padding:10px;width: 70%}
        span.comandolinux{background-color:#363636; color:#e0e0e0;font-style:italic;}
        span.comentario{color:#363636;font-style:italic;}
        span.importante{color:red;font-style:italic;}
        .texto_atu{padding:10px;border-radius: 5px; font-size:10pt;background-color:#363636; color:#40FF00}
    </style>
    <body>
        ...
        <?php
            ...
            $caminhoProprio = $caminho . "\OutrosProgramas\ProcedimentoDiario\\";
...
//               $cmd .= "git log --pretty=format:\"%str%h - %str%an, %str%ad : %str%s\" master --name-only --since=\"$dYY\" > " . 
    ...
    <ol>
        ...
        <div style="font-size:10pt; font-weight: bold; margin:10px">
            <a href=" ./separaFontesSubDir.php" target="_blank">Separar fontes do subdiretório</a></div>
         ** <i>Para comparar o que foi versionado, acessar o diretório "Oficial" e conferir tudo o que foi versionado, 
         ...
         git log --pretty=format:"%h - %an, %ad : %s" --name-only --since="<?php echo $dYY;?>" > 
            <?php echo $caminho; ?>OutrosProgramas\ProcedimentoDiario\logcommit.txt<br>
        ...
        <div class='container'>
            <ol>
                ...
                <br><li><i>Remover o arquivo atualizar.zip do diretório Compilados</i></li>

                <h4>Atualizar o sistema Trix</h4>
                <li>Acesse a AtualizacaoTRIX e gere o arquivo em_atualizacao.php.
                    <ul><li>Ao gerar esse arquivo e enviar para o sistema que será atualizado, ele mostra uma mensagem de que o sistema está em atualização. Não sendo necessário alterar a pasta do sistema para derrubar os usuários logados</li>
                ...
                <li>Abrir a planilha de checklist que está no Google Drive (SavyDocs) "CheckList Atualização Sistemas"
                    <ul><li>Observação: Está compartilhado essa planilha com as contas pessoais do google de cada analista</li></ul>
                </li>
...
<!--                            <textarea cols=100 rows="5" class='texto_atu'>INSERT INTO MesEmp (ID, DaData, AteData, Mensagem, DoAdmTrix, Ativo, Titulo, AbreTelaInic, LargMsg, AltMsg) VALUES ('', curdate(), curdate(), '<div style=\"font-size:18pt;padding:20px;line-height:40px; background-color:#F5DA81;\"><h2 style=\"font-size:24pt\">AVISO!</h2>O sistema Trix foi atualizado hoje!<br>Qualquer dúvida, entre em contato com o suporte Trix<br><br>Bom Trabalho!</div>', 'S', 'S', '', 'S', '850px', '400px')</textarea>-->
<!--                            <textarea cols=100 rows="5" class='texto_atu'><div style=\"font-size:18pt;padding:20px;line-height:40px; background-color:#F5DA81;border-radius:5px\"><h2 style=\"font-size:24pt\">COMUNICADO - ATUALIZAÇÃO DO SISTEMA!</h2>O sistema Trix foi atualizado hoje!<br>Qualquer dúvida, entre em contato com o suporte Trix<br><br>Bom Trabalho!</div></textarea>-->
                            <li>SQL para insert com validade para a data atual (esse SQL pode ser execultado pelo atualização):</li>
